            ...
            <div className="grid gap-6">
                <div className="flex items-start lg:justify-between lg:items-center flex-col lg:flex-row gap-5">
                    <div className="grid gap-2 w-full sm:w-72">
                        ...
                        <img src={user?.avatar?.url} alt="avatar" className='w-full h-auto sm:w-72 sm:h-72 rounded-2xl' />
                    </div>
                    <div className="grid gap-2 w-full sm:w-72">
                        <Label>Resume</Label>
                        <img src={user?.resume?.url} alt="resume" className='w-full h-auto sm:w-72 sm:h-72 rounded-2xl' />
                    </div>
                </div>
                <div className="grid gap-2">
